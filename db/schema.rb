...
ActiveRecord::Schema.define(version: 20180213120415) do
  ...
  create_table "comments", primary_key: "c_id", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "kahani", primary_key: "uid", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.bigint "insaan_id"
    t.index ["insaan_id"], name: "index_kahani_on_insaan_id"
  end
